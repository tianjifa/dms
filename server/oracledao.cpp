...
{12,4130,852,0,0,
5,0,0,0,0,0,60,40,0,0,0,0,0,1,0,
20,0,0,0,0,0,58,41,0,0,1,1,0,1,0,3,109,0,0,
39,0,0,1,0,0,27,43,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
70,0,0,2,0,0,30,54,0,0,0,0,0,1,0,
85,0,0,3,137,0,3,88,0,0,6,6,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,
1,3,0,0,
124,0,0,4,0,0,29,104,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (unsigned char  *)&g_context;
...

{
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (unsigned char  *)g_userpwd;
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "insert into dmslog  values (dmslog_id.nextval ,:b0,:b1,:b2,\
to_date(:b3,'yyyy-mm-dd hh24:mi:ss'),to_date(:b4,'yyyy-mm-dd hh24:mi:ss'),:b5\
)";
 sqlstm.iters = (unsigned int  )1;
 ...
 sqlstm.sqlety = (unsigned short)256;
 sqlstm.occurs = (unsigned int  )0;
 sqlstm.sqhstv[0] = (unsigned char  *)(g_log.logname);
 ...
 sqlstm.sqadto[0] = (unsigned short )0;
 sqlstm.sqtdso[0] = (unsigned short )0;
 sqlstm.sqhstv[1] = (unsigned char  *)(g_log.logip);
 ...
 sqlstm.sqhstv[2] = (unsigned char  *)&(g_log.pid);
 ...
 sqlstm.sqhstv[3] = (unsigned char  *)(g_log.logintime);
 ...
 sqlstm.sqhstv[4] = (unsigned char  *)(g_log.logouttime);
 ...
 sqlstm.sqhstv[5] = (unsigned char  *)&(g_log.durations);
